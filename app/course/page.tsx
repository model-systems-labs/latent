...
export default function CourseCatalogPage() {
  ...
  return (
    <main>
      <PageAtmosphere />
      <header className="site-header course-header"><Link className="wordmark" href="/"><i />latent</Link><nav><Link href="/course">Courses</Link><Link href="/workspace" aria-label="Open coding workspace">Code</Link><Link href="/flashcards" aria-label="Flash cards">Cards</Link><Link href="/sources">Further reading</Link></nav></header>
