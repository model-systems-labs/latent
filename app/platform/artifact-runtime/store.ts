...
import { assertArtifactEnvelope } from "./core";
import { createArtifactBundle, parseArtifactBundle } from "./portable";
import type { ArtifactEnvelope, ArtifactHeadRecord, PortableArtifactBundle } from "./types";
