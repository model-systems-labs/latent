...
expect(
  learningValidation.valid && learningValidation.pack.lessons.length === 1,
  "content.learningPack.lessons",
  "The tiny player intentionally renders exactly one lesson.",
);
expect(
...
if (questionValidation.valid) validateTinyQuestionPlayer(questionValidation.library);
