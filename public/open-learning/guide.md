...
The authoritative machine-readable schemas are [`learning-pack.schema.json`](./learning-pack.schema.json) and [`learning-feed.schema.json`](./learning-feed.schema.json). A complete example lives at [`examples/open-learning/reliable-llm-changes/learning-pack.json`](./reliable-llm-changes/learning-pack.json).
