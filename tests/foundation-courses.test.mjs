...
before(async () => {
  ...
  [
    ...
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/foundations/exercise-contracts.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/content/foundations/contracts.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/implementation-source.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/content/foundations/manifests.ts"),
...
test("batching explains why one output bias is shared before asking learners to broadcast it", async () => {
  ...
  const learning = await readFile(new URL("../examples/learning-platform/llm-learning/content/foundations/learning.ts", import.meta.url), "utf8");
