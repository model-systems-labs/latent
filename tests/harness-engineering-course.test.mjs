...
before(async () => {
  ...
  [
    ...
    vite.ssrLoadModule("/app/lessons/contract-suite.ts"),
    vite.ssrLoadModule("/app/lessons/course.ts"),
    vite.ssrLoadModule("/app/lessons/harness-engineering/exercise-contracts.ts"),
    vite.ssrLoadModule("/app/lessons/exercise-contracts.ts"),
    vite.ssrLoadModule("/app/content/harness-engineering/experiments.ts"),
