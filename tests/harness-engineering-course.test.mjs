...
before(async () => {
  ...
  [
    ...
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/contract-suite.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/course.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/harness-engineering/exercise-contracts.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/exercise-contracts.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/content/harness-engineering/experiments.ts"),
    ...
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/content/harness-engineering/learning.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/learning.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/content/harness-engineering/manifest.ts"),
    vite.ssrLoadModule("/examples/learning-platform/llm-learning/content/harness-engineering/project-template.ts"),
