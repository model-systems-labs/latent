...
const lessonSourceUrl = new URL("../examples/learning-platform/llm-learning/lessons/harness-engineering/index.ts", import.meta.url);
const expectedIds = [
...
before(async () => {
  ...
  scenariosModule = await vite.ssrLoadModule("/examples/learning-platform/llm-learning/content/harness-engineering/scenarios.ts");
});
