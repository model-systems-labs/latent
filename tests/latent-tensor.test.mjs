...
const lessonSourceModule = await vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/implementation-source.ts");
const courseModule = await vite.ssrLoadModule("/examples/learning-platform/llm-learning/lessons/course.ts");
